...
Different SQL databases have various [data types](sql_datatypes.asp.html) to store date and time values.
...
**Note:** The date data type are defined for a column upon creation of a new table in your database.
