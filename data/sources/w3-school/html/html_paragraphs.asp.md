...
```javascript
<p>This paragraphcontains a lot of linesin the source code,but the browserignores it.</p><p>This paragraphcontains         a lot of spacesin the source         code,but the        browserignores it.</p>
```
...
## Video: HTML Paragraphs
 ...
 ![Tutorial on YouTube](images/06_html_paragraphs.png)](https://youtu.be/qis4kAOThLw&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s)
