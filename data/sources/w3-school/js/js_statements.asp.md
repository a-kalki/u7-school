...
```javascript
let a, b, c;  // Declare 3 variablesa = 5;        // Assign the value 5 to ab = 6;        // Assign the value 6 to bc = a + b;    // Assign the sum of a and b to c
```
...
Our [Reserved Words Reference](js_reserved.asp.html) lists all JavaScript keywords.
...
## Video: JavaScript Statements
 ...
 ![Tutorial on YouTube](images/img_javascript_statements.png)](https://youtu.be/ZjotKN861EI&list=PLP9IO4UYNF0WWmZpE3W33vVPRl2GvjEqz)
