...
Show all Nature Cars People

![Mountains](https://www.w3schools.com/w3images/mountains.jpg)
...
![Car](https://www.w3schools.com/w3images/cars1.jpg)

#### Retro

Lorem ipsum dolor..

![Car](https://www.w3schools.com/w3images/cars2.jpg)

#### Fast

Lorem ipsum dolor..

![Car](https://www.w3schools.com/w3images/cars3.jpg)

#### Classic

Lorem ipsum dolor..

![Car](https://www.w3schools.com/w3images/people1.jpg)

#### Girl

Lorem ipsum dolor..

![Car](https://www.w3schools.com/w3images/people2.jpg)

#### Man

Lorem ipsum dolor..

![Car](https://www.w3schools.com/w3images/people3.jpg)

#### Woman

Lorem ipsum dolor..

[Try it Yourself »](https://www.w3schools.com/howto/tryit.asp?filename=tryhow_js_portfolio_gallery_filter)
...
```javascript
filterSelection("all") // Execute the function and show all columnsfunction filterSelection(c) {  var x, i;  x = document.getElementsByClassName("column");  if (c == "all") c = "";  // Add the "show" class (display:block) to the filtered elements, and remove the "show" class from the elements that are not selected  for (i = 0; i < x.length; i++) {    w3RemoveClass(x[i], "show");    if (x[i].className.indexOf(c) > -1) w3AddClass(x[i], "show");  }}// Show filtered elementsfunction w3AddClass(element, name) {  var i, arr1, arr2;  arr1 = element.className.split(" ");  arr2 = name.split(" ");  for (i = 0; i < arr2.length; i++) {    if (arr1.indexOf(arr2[i]) == -1) {      element.className += " " + arr2[i];    }  }}// Hide elements that are not selectedfunction w3RemoveClass(element, name) {  var i, arr1, arr2;  arr1 = element.className.split(" ");  arr2 = name.split(" ");  for (i = 0; i < arr2.length; i++) {    while (arr1.indexOf(arr2[i]) > -1) {      arr1.splice(arr1.indexOf(arr2[i]), 1);    }  }  element.className = arr1.join(" ");}// Add active class to the current button (highlight it)var btnContainer = document.getElementById("myBtnContainer");var btns = btnContainer.getElementsByClassName("btn");for (var i = 0; i < btns.length; i++) {  btns[i].addEventListener("click", function(){    var current = document.getElementsByClassName("active");    current[0].className = current[0].className.replace(" active", "");    this.className += " active";  });}
```

**Tip:** Also check out [Portfolio Gallery](howto_css_portfolio_gallery.asp.html)