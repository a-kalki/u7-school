...
[Home](javascript:void\(0\)) [About](javascript:void\(0\)) [Contact](javascript:void\(0\))

  Login

[Try it Yourself »](https://www.w3schools.com/howto/tryit.asp?filename=tryhow_css_login_form_navbar)
