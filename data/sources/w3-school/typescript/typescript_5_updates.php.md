...
```javascript
type DynamicObject = { [key: `dynamic_${string}`]: string };// Usage:let obj: DynamicObject = { dynamic_key: "value" };
```
...
The TypeScript 'private' still works as discussed in [Classes](typescript_classes.php.html) section.
