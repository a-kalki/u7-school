...
// ? Как работает этот вложенный тернарник? Разложи по шагам.
// ? Если score = 45 — что будет? А если score = 95?
...
// ? Тернарный оператор ОБЯЗАТЕЛЬНО должен иметь обе ветки: ? и :
...
// ? Что здесь важно? Какая часть выполняется? Обе или одна?

// А теперь попробуй:
let val = 5;
let msg = 'Число: ' + val > 0 ? 'положительное' : 'отрицательное';
console.log(msg);
// ? Что выведет? Есть ли здесь проблема с приоритетом?
