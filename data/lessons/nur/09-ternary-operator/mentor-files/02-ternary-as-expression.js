...
let max = a > b ? a : b;
console.log('max =', max);
// ? Можно ли сделать так с if? let max = if (a > b) { a } else { b };
// Попробуй — что скажет интерпретатор?
...
// ? Тот же результат, но больше кода
...
// ? Тернарник удобно использовать прямо внутри ${}. if так не получится.
...
// ? Сколько здесь тернарников? Какой порядок выполнения?
// ? Подсказка: вложенный тернарник читается справа налево по else-веткам

// Лучше с группировкой:
let shipping2 = items > 10 ? 0 : (items > 5 ? 500 : 1000);
console.log('С группировкой:', shipping2, 'тг');
// ? Результат тот же, но читается понятнее
