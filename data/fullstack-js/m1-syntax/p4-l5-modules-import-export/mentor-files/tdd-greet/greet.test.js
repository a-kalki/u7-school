...
// beforeAll(() => {
//   console.log('  [beforeAll — глобальный]');
// });
// beforeEach(() => {
//   console.log('    [beforeEach — глобальный]');
// });
// afterEach(() => {
//   console.log('    [afterEach — глобальный]');
// });
// afterAll(() => {
//   console.log('  [afterAll — глобальный]');
// });
...
describe('Общий скоуп', () => {
  ...
  describe('разные проверки expect', () => {
    ...
    test('.toEqual — глубокое сравнение', () => {
      expect({ name: 'Алия', age: 23 }).toEqual({
        name: 'Алия',
        age: 23,
      });
    });
  ...
  console.log('cb - Конец общего скоупа');
});
