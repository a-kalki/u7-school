...
| Пользовательский сценарий | `<StoryName>Story` | `CatalogStory` | `apps/u7-bot/src/controllers/streams/stories/stream-catalog.story.ts` |
| Контроллер (бот) | `<ModuleName>Controller` | `StreamsController` | `apps/u7-bot/src/controllers/streams/controller.ts` |
