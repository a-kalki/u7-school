...
> ⚠️ **Границы доменной логики:** правила распределения логики между модулями и предотвращения утечек — см. [domain-boundaries.md](./domain-boundaries.md). Обязательно к ознакомлению.
