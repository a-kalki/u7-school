...
> **Материнский документ:** [bot-ui-session-architecture.md](../../roadmap/bot-ui-session-architecture.md) — целевая архитектура bot-ui v4 (инварианты §3, контракты §4, карта кода §11, решения трека 1.1 §10.10–16). Трек 5 декомпозиции §9, финальный миграционный.
