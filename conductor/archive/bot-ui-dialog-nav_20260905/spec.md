...
> **Материнский документ:** [bot-ui-session-architecture.md](../../roadmap/bot-ui-session-architecture.md) — целевая архитектура bot-ui v4 (инварианты §3, контракты §4, рендер и валидация §5, команды §6, решения трека 1.1 §10.10–16). Трек 2 декомпозиции §9.
