...
- [ ] Task: Реорганизовать слой `auto-ui` с подпапками в `@u7/core`
    - [ ] Создать структуру: `auto-ui/app/`, `auto-ui/module/`, `auto-ui/controller/`, `auto-ui/parser/`
    - [ ] Перенести файлы в соответствующие подпапки
    - [ ] Обновить `index.ts` и все импорты
