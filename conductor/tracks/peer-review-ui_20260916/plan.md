...
- [ ] Task: Подписка на `campaign.created` → приглашения участникам: три шаблона текстов (студенту-«завершившему»; студенту «забросил»/«не начал»; ментору), механика `ProactiveSender.invite` (ФР-6), кнопка `💬 Отзывы` → S03 кампании
