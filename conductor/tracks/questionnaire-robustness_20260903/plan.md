...
- [x] Task: Исследование: воспроизвести интерливинг (двойной `/start` + answer-callback в одной пачке апдейтов), задокументировать механику перезаписи `session.lastBotMessage` прямо в этом плане [86f0cf3]
