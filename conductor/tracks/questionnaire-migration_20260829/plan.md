...
- [ ] Task: Выборочная ручная сверка содержимого: пара completed-анкет (мульти-ответы, goal_text, пул-снимок, ownerInfo, даты), wish fulfilled для студента и confirmed для остальных
