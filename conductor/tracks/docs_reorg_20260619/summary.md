...
- Ряд `skills/`-файлов превышают 100 строк (`entity.md` 347, `repo-impl.md` 272, `policy.md` 212) — кандидаты на сокращение в отдельном треке (FR6 текущего трека охватывал только `bot-test.md` и `bot-user-story.md`).
