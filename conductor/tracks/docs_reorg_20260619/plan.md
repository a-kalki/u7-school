...
- [ ] Task: Объединить `errors.md` → `skills/errors.md`
  ...
  - [ ] Перенести в `skills/errors.md`
  - [ ] Удалить `errors.md`
  - [ ] Обновить ссылки в `product-guidelines.md`, `index.md`, ddd-скиллах

- [ ] Task: Перенести `integration.md` → `architecture.md`
  - [ ] Извлечь: правила DI, запрет прямого импорта UC, фасады
  - [ ] Добавить секцией в `architecture.md`
...
- [ ] Task: Проанализировать все файлы документации на связность
  ...
  - [ ] Следовать скиллу `conductor-docsk
