...
- [x] Task: **Восстановить кнопочные проактивы 7a/7b через `invite`** (решение владельца на ревью финала): код + тесты с keyboard-ассертами + возврат ui-spec к кнопочному описанию — функциональность не теряется при миграции [af3029f9]
- [x] Conductor - User Manual Verification 'Финал' (Protocol in workflow.md)
