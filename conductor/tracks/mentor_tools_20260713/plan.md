...
- [x] Task: Написать тесты: MENTOR → «🛠️ Инструменты ментора» → подменю (Мои потоки / Создать поток / Мониторинг) [a962224]
- [x] Task: Реализовать MentorToolsStory или контроллер с подменю (role-gated `MENTOR`) [a962224]
...
- [ ] Task: Активировать ViewStreamMentorStory: снять `describe.skip`, зарегистрировать в MentorController
