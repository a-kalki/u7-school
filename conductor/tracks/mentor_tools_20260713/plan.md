...
- [x] Task: Написать тесты: карточка студента с прогрессом, причиной отставания, статистикой времени (🏃/⚡/📝/📚)
- [x] Task: Реализовать статистику: вычисление длительности шагов (completedAt - issuedAt), группировка по категориям
