...
- [x] Task: streams S03 «Программа курса» (ФР-4): блок = проект с уроками
    ...
    - [x] Red: стори-тест длинной программы (границы страниц по целым
          проектам, `‹ Пред`/`След ›` одним рядом, `Стр. N/M`, кеш — домен
          не перечитывается при тыке, смена диалога → пересборка)
          — e25d390
    - [x] Green: реализация — e25d390
- [x] Task: courses S00 уровни 0–4 (ФР-5): блок = элемент уровня с inline-детьми,
