...
- [Архитектурная эволюция Stream](tracks/mentor_tools_20260713/architecture-evolution.md) — объединяющий документ треков Релизов 1–3 (Курс, ЖЦ студента, ContentPath, gating, навигация, витрина, мониторинг)
