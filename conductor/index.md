...
- [Сессия, сообщения и флоу](./bot-ui-session-architecture.md) — самодостаточный документ для проработки концепции: as-is архитектура, проблемы П1–П5 (владение сообщениями, конкурентность, stale-взаимодействия), сценарии гонок, минимальный guard, карта кода, открытые вопросы. Родился из трека questionnaire-robustness
