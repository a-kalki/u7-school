...
- [Реализация системы задач и уведомлений](./tasks-system-implementation.md) — **точка входа в треки**: этап A (механизм `userFacade.notify` + перенос уведомлений), этап B (модуль задач)
