...
- [Тестовые миры — концепция](./guides/test-worlds.md) — декларативные миры вместо ручных фикстур: world-kit, композиции миров, запуск (WORLD=/buildWorld), продуктовое качество контента
