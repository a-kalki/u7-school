...
1.  **Загрузи контекст проекта:**
    ...
    -   **Загрузи DDD styleguide-скиллы:** Загрузи все четыре скилла — `ddd-domain`, `ddd-api`, `ddd-infra`, `ddd-naming`. Они содержат ключевые правила, по которым будет проверяться код. При проверке каждого файла сверяйся с правилами из соответствующего скилла.
