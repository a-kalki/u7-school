...
| `#telegram` `#markdownv2` `#proactive` | Неэкранированные скобки вокруг t.me-ссылки ломают разбор MarkdownV2 — проактивное сообщение не доставляется | [markdownv2-unescaped-parens-around-link.md]($T1markdownv2-unescaped-parens-around-link.md) |
