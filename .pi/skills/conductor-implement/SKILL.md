...
4.  **Загрузи Styleguide-скиллы:**
    ...
    d. **При ошибках загружай:** `troubleshoot` — при столкновении с неожиданными ошибками, странным поведением библиотек.
    e. **При написании кода:** Сверяйся с ключевыми правилами из загруженных скиллов. Если нужен полный пример кода — читай styleguide-файл из карты внутри скилла.
