...
export const STUDENT_LIST: StudentEntry[] = [
  ...
  {
    name: 'Нұрым',
    telegramId: 1274181696,
    uuid: '5af02d03-952b-4914-9b86-8a94a9e127c1',
    lesson: 'пропустить',
  },
  {
    name: 'Vice',
    telegramId: 1886053369,
    uuid: 'f3abd8ad-95dd-4b5f-86f8-b14c97b48c64',
    lesson: 'пропустить',
  },
  {
    name: 'Ибрахим',
    telegramId: 7976471166,
    uuid: '62b1080d-2ad0-4e16-88eb-ea20ac1fa0ae',
    lesson: 'середина p1',
  },
  {
    name: 'Aidar',
    telegramId: 952537114,
    uuid: 'd9f1694f-ef7e-495f-9389-080da724828f',
    lesson: 'середина p1',
  },
  {
    name: 'Nur',
    telegramId: 671999593,
    uuid: '0f6e594c-b6ab-4ed4-af6d-d4406dae4b8e',
    lesson: 'середина p1',
  },
  {
    name: 'Ismail',
    telegramId: 2023546466,
    uuid: 'c77ace46-414f-4a0b-97c2-da5ecc5fbdc3',
    lesson: 'середина p2',
  },
  {
    name: 'nurts.nu',
    telegramId: 6888927793,
    uuid: 'fef43a67-0bae-4759-b172-057736aa5401',
    lesson: 'середина p1',
  },
  {
    name: 'Asema🤍',
    telegramId: 923356508,
    uuid: '51a05e8f-b339-47e3-bb62-119aa8558363',
    lesson: 'начало p1',
  },
  {
    name: 'Мират ☀️',
    telegramId: 7339477355,
    uuid: '4e7d618a-0cb1-40a4-bf2e-add225b14c29',
    lesson: 'начало p1',
  },
  {
    name: 'Dina',
    telegramId: 795572232,
    uuid: '0cba1f15-c7bc-448c-9064-d9eab302a185',
    lesson: 'середина p3',
  },
  {
    name: 'Zarina',
    telegramId: 756418382,
    uuid: '7e76a369-2e20-4075-bbf0-b6648ea3bc21',
    lesson: 'середина p3',
  },
  {
    name: 'нур',
    telegramId: 1474054578,
    uuid: 'e1be6010-717e-448e-8a08-a27f4eeb6850',
    lesson: 'середина p2',
  },
  {
    name: 'Laura',
    telegramId: 1060467091,
    uuid: '068e0099-db55-4acd-8709-9a05b1b95b4b',
    lesson: 'пропустить',
  },
  {
    name: 'Мария',
    telegramId: 8960175810,
    uuid: '81a4ebf2-7186-43fe-b877-17f8fa4e0e2d',
    lesson: 'пропустить',
  },
  {
    name: 'ᅠᅠ',
    telegramId: 7467906232,
    uuid: '98993dd2-b888-47be-9bb3-f9dbef694de1',
    lesson: 'середина p1',
  },
];
...
export function parseLessonLabel(
  label: string,
): { projectIndex: number; lessonIndex: number } | null {
 ...
 */
export function findStudentByTelegramId(
  telegramId: number,
