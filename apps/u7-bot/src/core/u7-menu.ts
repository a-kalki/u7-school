/**
 * Декларативная кнопка главного меню (ФР-4):
 * данные (кнопка, описание, приоритет), не обработчик. Сбор —
 * `menuButtons(actor)` у стори/контроллеров (асинхронный контракт —
 * проверки видимости могут звать фасады, ФР-7), экран — uiApp.
 */
