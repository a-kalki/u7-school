...
import type { ApplicationListFilter, ApplicationRepo } from "#domain/application/repo";
...
export class ApplicationJsonRepo implements ApplicationRepo {
   ...
   */
  constructor(
    filePath = "data/onboarding/applications.json",
    db?: BaseJsonDb,
  ) {
    this.#repo = new JsonFileRepo(ApplicationSchema, filePath, db, "applications");
  }
