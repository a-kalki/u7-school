...
const NEED_METADATA: { file: string; durationMin: number; parts: number }[] = [
  { file: "Глобальная, локальная и время жизни переменной.md", durationMin: 78, parts: 4 },
  { file: "Знакомимся с html, css, js. Как грузится html и выполняется js.md", durationMin: 91, parts: 5 },
  { file: "Отладка кода js в браузере.md", durationMin: 55, parts: 3 },
  { file: "Пишем первый код и подкрепляем теорию практикой.md", durationMin: 79, parts: 4 },
];
